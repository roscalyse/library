                ...
                <div class="row ">
                    <div class="col-12  align-self-center">
                        <div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded">
                            <div class="w-sm-100 mr-auto"><h4 class="mb-0">Add Student</h4></div>
                                            ...
                                            <form method="POST">
                                             <div class="form-row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <button type="submit" name="addStudent" class="btn btn-primary">Add Student</button>   <button type="submit" class="btn btn-outline-warning">Reset</button>
